...
let numbersArr = [
  ...
  { number: 18, color: '#ffc93c' },
  { number: 16, color: '#fac945' },
  { number: 16, color: '#f5ca4f' },
  { number: 15, color: '#f0ca58' },
  { number: 12, color: '#ebcb62' },
  { number: 10, color: '#e6cc6b' },
  { number: 9, color: '#e1cc75' },
  { number: 8, color: '#dccd7f' },
  { number: 9, color: '#d7ce88' },
  { number: 10, color: '#d2ce92' },
  { number: 11, color: '#cecf9b' },
